...
def backtest(df, initial_balance=10000000):
    ...
    for i in range(len(df)):
        ...
        # 새로운 거미줄 매도 주문 생성 (평단가 수익률 2% 이상일 때)
...
def main():
    ...
    trade_df.to_csv('trade_backtest_v2.csv', index=False)
    print("Trade history saved to 'trade_backtest_v2.csv'")
