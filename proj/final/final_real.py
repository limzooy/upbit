...
# import numpy as np
# import pandas as pd
# from db_model import SessionLocal, StatusLog, Trade  # DB 연동을 위해 import
...
# def log_trade(trade_type, amount, price):
...
#                             log_trade("buy", order['amount'] / order['price'], order['price'])  # 매수 기록 저장
#                 if not web_orders:
#                     is_web_active = False
...
#                             log_trade("sell", order['amount'], order['price'])  # 매도 기록 저장
